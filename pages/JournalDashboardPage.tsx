    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex justify-between items-center mb-8">
            ...
            {!isPremium && (
              <div className="mt-2">
                <p className="text-sm text-gray-600">
                  Entries: {entryCount} / {maxFreeEntries} 
                  {entryCount >= maxFreeEntries && (
                ...
                <div className="mt-1 w-64 bg-gray-200 rounded-full h-2">
                  <div 
                    className={`h-2 rounded-full ${
                      entryCount >= maxFreeEntries ? 'bg-red-500' : 'bg-teal-500'
                    }`}
                    style={{ width: `${Math.min((entryCount / maxFreeEntries) * 100, 100)}%` }}
                  ></div>
                </div>
              </div>
            )}
        ...
        <button
          ...
          disabled={!isPremium && entryCount >= maxFreeEntries}
